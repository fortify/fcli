...
public class SCSastScanStartOptionsArgGroup {
    @ArgGroup(exclusive = false, headingKey = "fcli.sc-sast.scan.start.mbs.heading") private SCSastScanStartMbsOptions mbsOptions;
    @ArgGroup(exclusive = false, headingKey = "fcli.sc-sast.scan.start.package.heading") private SCSastScanStartPackageOptions packageOptions;
