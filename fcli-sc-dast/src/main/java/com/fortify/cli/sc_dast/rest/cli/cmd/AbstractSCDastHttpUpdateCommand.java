...
import com.fortify.cli.common.rest.cli.cmd.AbstractHttpUpdateCommand;
...
/**
 * This base class for 'update' {@link Command} implementations provides capabilities for running 
 * SC-DAST requests and outputting detailed results.
 *   
 * @author rsenden
 */
@ReflectiveAccess @FixInjection
public abstract class AbstractSCDastHttpUpdateCommand extends AbstractHttpUpdateCommand {
