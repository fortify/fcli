...
import com.fortify.cli.ssc.access_control.helper.SSCTokenUpdateRequest;
...
@Command(name = "update-token") @CommandGroup("token")
public class SSCTokenUpdateCommand extends AbstractSSCTokenCommand implements IRecordTransformer {
    ...
    @EnvSuffix("ID") @Parameters(arity="1", paramLabel = "token-id", descriptionKey = "fcli.ssc.access-control.update-token.token-id") private String tokenId;
