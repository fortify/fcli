...
public class SSCArtifactDeleteCommand extends AbstractSSCArtifactOutputCommand implements IJsonNodeSupplier, IActionCommandResultSupplier {
    ...
    public JsonNode getJsonNode() {
        ...
        return SSCArtifactHelper.delete(unirest, artifactResolver.getArtifactDescriptor(unirest)).asJsonNode();
    }
