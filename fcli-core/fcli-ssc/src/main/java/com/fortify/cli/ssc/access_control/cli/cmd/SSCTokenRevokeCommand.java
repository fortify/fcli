...
@Command(name = "revoke-token") @CommandGroup("token")
public class SSCTokenRevokeCommand extends AbstractSSCTokenCommand implements IRecordTransformer {
    @Getter @Mixin private OutputHelperMixins.TableNoQuery outputHelper;
    @EnvSuffix("TOKENS") @Parameters(arity="1..", descriptionKey = "fcli.ssc.access-control.revoke-token.idsOrValues") private String[] tokenIdsOrValues;
