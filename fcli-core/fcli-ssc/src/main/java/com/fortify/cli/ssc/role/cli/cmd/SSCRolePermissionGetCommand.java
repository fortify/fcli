...
import com.fortify.cli.ssc.role.cli.mixin.SSCRolePermissionResolverMixin;
...
@Command(name = SSCOutputHelperMixins.GetPermission.CMD_NAME) @CommandGroup("permission")
public class SSCRolePermissionGetCommand extends AbstractSSCBaseRequestOutputCommand implements IRecordTransformer {
    @Getter @Mixin private SSCOutputHelperMixins.GetPermission outputHelper; 
