 ...
 * @author rsenden
 */
public final class SSCAttributeListHelper {
     ...
     */
    public SSCAttributeListHelper request(String name, HttpRequest<?> request) {
     ...
     * @return
     */
    public SSCAttributeListHelper attributeDefinitionHelper(SSCAttributeDefinitionHelper attributeDefinitionHelper) {
        this.cachedAttributeDefinitions = attributeDefinitionHelper.getAttributeDefinitions();
        return this;
    }
    
    public SSCAttributeListHelper attrIdsToInclude(Set<String> attrIdsToInclude) {
    ...
    public JsonNode execute(UnirestInstance unirest, String applicationVersionId) {
        ...
        return new SSCAttributeHelper(cachedAttributeDefinitions, attrIdsToInclude)
