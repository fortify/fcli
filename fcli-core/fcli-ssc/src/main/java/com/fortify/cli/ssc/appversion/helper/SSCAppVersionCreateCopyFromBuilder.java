...
public final class SSCAppVersionCreateCopyFromBuilder {
    ...
    public final SSCAppVersionCreateCopyFromBuilder setCopyOptions(SSCCopyOption[] copyOptions) {
        if(copyOptions == null) {
            copyOptions = SSCCopyOption.values();
        }
        for (SSCCopyOption option : copyOptions) {
