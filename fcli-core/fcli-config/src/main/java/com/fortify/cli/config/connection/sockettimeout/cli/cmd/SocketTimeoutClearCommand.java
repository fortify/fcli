...
public class SocketTimeoutClearCommand extends AbstractOutputCommand implements IJsonNodeSupplier, IActionCommandResultSupplier{
    @Mixin @Getter private OutputHelperMixins.Clear outputHelper;
    
    @Override
    public JsonNode getJsonNode() {
        return ConnectionHelper.deleteAllTimeouts(TimeoutType.SOCKET).map(TimeoutDescriptor::asJsonNode).collect(JsonHelper.arrayNodeCollector());
    }
