...
public class SocketTimeoutAddCommand extends AbstractOutputCommand implements IJsonNodeSupplier{
    ...
    public JsonNode getJsonNode() {
        return ConnectionHelper.addTimeout(timeoutOptions.asTimeoutDescriptor(TimeoutType.SOCKET)).asJsonNode();
    }
