...
public class ConnectTimeoutUpdateCommand extends AbstractOutputCommand implements IJsonNodeSupplier, IActionCommandResultSupplier {
    @Mixin @Getter private OutputHelperMixins.Update outputHelper;
    @Mixin private TimeoutOptions timeoutOptions;
    
    @Override
    public JsonNode getJsonNode() {
        return ConnectionHelper.updateTimeout(timeoutOptions.asTimeoutDescriptor(TimeoutType.CONNECT)).asJsonNode();
    }
