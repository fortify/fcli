...
public class SocketTimeoutListCommand extends AbstractOutputCommand implements IJsonNodeSupplier {
    @Mixin @Getter private OutputHelperMixins.List outputHelper;
    
    @Override
    public JsonNode getJsonNode() {
        return ConnectionHelper.getTimeoutsStream(TimeoutType.SOCKET).map(TimeoutDescriptor::asJsonNode).collect(JsonHelper.arrayNodeCollector());
    }
