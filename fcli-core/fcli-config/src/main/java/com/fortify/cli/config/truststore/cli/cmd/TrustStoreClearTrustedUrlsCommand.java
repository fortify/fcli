...
@Command(name = "clear-trusted-urls")
public class TrustStoreClearTrustedUrlsCommand extends AbstractOutputCommand
    implements IJsonNodeSupplier, IActionCommandResultSupplier, IRecordTransformer
{
    ...
    public JsonNode getJsonNode() {
        return TrustedUrlTrustStoreHelper.clearTrustedUrls()
