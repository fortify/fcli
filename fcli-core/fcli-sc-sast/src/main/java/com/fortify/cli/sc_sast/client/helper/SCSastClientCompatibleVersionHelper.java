 ...
 * without notice.
 */
package com.fortify.cli.sc_sast.client.helper;
...
/**
 * Helper class for determining ScanCentral SAST client compatible versions.
...
public class SCSastClientCompatibleVersionHelper {
