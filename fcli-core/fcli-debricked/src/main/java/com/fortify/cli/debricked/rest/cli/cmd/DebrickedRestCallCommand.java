...
import com.fortify.cli.debricked._common.rest.helper.DebrickedProductHelper;
...
public final class DebrickedRestCallCommand extends AbstractRestCallCommand {
    ...
    @Getter private final DebrickedProductHelper productHelper = DebrickedProductHelper.INSTANCE;
}