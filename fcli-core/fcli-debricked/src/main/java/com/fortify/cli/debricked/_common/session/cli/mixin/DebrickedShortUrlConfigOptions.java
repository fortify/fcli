...
public class DebrickedShortUrlConfigOptions extends ConnectionConfigOptions implements IDebrickedUrlConfigOptions {
    @Option(names = {"--url"}, required = true, order=1, defaultValue = "https://debricked.com", hidden = true)
