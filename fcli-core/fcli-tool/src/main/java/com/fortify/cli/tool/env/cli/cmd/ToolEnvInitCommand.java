...
public class ToolEnvInitCommand extends AbstractOutputCommand implements IActionCommandResultSupplier {
    ...
    @Builder @Reflectable
    private record ToolSetupResult(String name, String version, String binDir, String installDir, String __action__) {}
    
    // Record to hold registration result
    @Builder
    private record RegistrationResult(String version, String binDir, String installDir, boolean success) {}
    
    // Record to hold install result
    @Builder
    private record InstallResult(String binDir, String installDir, String action) {}
