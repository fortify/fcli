...
/**
 * RPC method handler for SSC session logout.
 * 
 * Method: fcli.ssc.logout
...
public final class RpcMethodHandlerSscLogout implements IRpcMethodHandler {
    private final ObjectMapper objectMapper;
    private final RpcSessionManager sessionManager;
    
    @Override
    public JsonNode execute(JsonNode params) throws RpcMethodException {
        log.debug("SSC logout");
        return sessionManager.executeLogout(ProductType.SSC);
    }
}
