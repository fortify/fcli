...
public final class RPCMethodHandlerCacheGetPage implements IRPCMethodHandler {
    private final FcliRecordsCache cache;

    @Override
    public String description() {
        return "Retrieve a page of results from cache by cacheKey (works for both fcli.executeAsync and streaming fn.* calls)";
    }
