...
public final class FoDActionSpelFunctions {
    ...
    @MethodDescriptor("Retrieves the release information based on the provided release name or ID and" 
    ...
    public final @ReturnDescriptor("a JSON object containing the release details") ObjectNode release(@ParamDescriptor("the name or ID of the release to retrieve") String nameOrId) {
    ...
    @MethodDescriptor("Generates a browser-accessible deep link URL for a given issue based on its vulnerability ID."
    ...
    public @ReturnDescriptor("a browser-accessible URL string pointing to the issue's detail page") String issueBrowserUrl(@ParamDescriptor("a JSON object representing the issue; expected to contain a field named `vulnId`") ObjectNode issue) {
    ...
    @MethodDescriptor("Constructs a browser-accessible deep link URL for the release specified in the given application version JSON object."
    ...
    public @ReturnDescriptor("a fully evaluated URL string for accessing the release in a browser") String releaseBrowserUrl(@ParamDescriptor("the JSON object representing an application version, expected to contain a `releaseId` field") ObjectNode appversion) {
        var deepLinkExpression = baseUrl()
    ...
    @MethodDescriptor("Generates a browser-accessible deep link URL for the application specified in the given application version JSON object."
    ...
    public @ReturnDescriptor("a fully evaluated deep link URL string to access the application details in a browser") String appBrowserUrl(@ParamDescriptor("a JSON object representing the application version, expected to contain an `applicationId` field") ObjectNode appversion) {
        var deepLinkExpression = baseUrl()
