...
public final class ActionStepRunFcliEntry extends AbstractActionStepElement implements IMapKeyAware<String> {
    ...
    public static final class ActionStepFcliForEachDescriptor extends AbstractActionStepElementForEachRecord {
