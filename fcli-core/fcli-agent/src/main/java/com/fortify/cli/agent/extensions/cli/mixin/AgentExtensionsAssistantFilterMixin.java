 ...
 */
public class AgentExtensionsAssistantFilterMixin {
    @Getter
    @Option(names = {"--assistants"}, split = ",", paramLabel = "<name>",
        descriptionKey = "fcli.agent.extensions.assistants")
    private Set<String> assistants;

    @Getter
    @Option(names = {"--exclude-assistants"}, split = ",", paramLabel = "<name>",
        descriptionKey = "fcli.agent.extensions.exclude-assistants")
