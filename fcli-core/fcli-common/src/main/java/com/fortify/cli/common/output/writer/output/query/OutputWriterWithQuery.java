...
/**
 * TODO Refactor this class once all commands have been refactored to use
 * {@link OutputHelperMixins}; all picocli annotatations should be removed, as
 * they will be passed by {@link OutputWriterWithQueryFactoryMixin} through our
 * constructor. As this class by then will no longer be a mixin, it should be
 * renamed to OutputWriterWithQuery, and moved to the writer.output.query
 * package.
 *
 * @author rsenden
 *
...
public class OutputWriterWithQuery implements IOutputWriter {
    ...
    public OutputWriterWithQuery(CommandSpec mixee, IOutputOptions outputOptions, IQueryExpressionSupplier queryExpressionSupplier,
            StandardOutputConfig defaultOutputConfig) {
