...
public abstract class AbstractGenerateConfigCommand extends AbstractOutputCommand
        implements
            IJsonNodeSupplier,
            IActionCommandResultSupplier {
    @Mixin
    private CommonOptionMixins.RequireConfirmation requireConfirmation;
    ...
    public final JsonNode getJsonNode() {
        ...
        return JsonHelper.getObjectMapper().createObjectNode().put("path", outputPath.toString());
    }
