...
public class StandardOutputWriter implements IOutputWriter {
    ...
    private IRecordConsumer recordConsumer(IRecordWriter rw) { return r->{ rw.append(r); return com.fortify.cli.common.util.Break.FALSE; }; }
    ...
    private static final RecordWriterFactory getRecordWriterFactoryOrDefault(StandardOutputConfig outputConfig, IOutputOptions outputOptions) {
        var result = outputOptions==null || outputOptions.getOutputFormatConfig()==null ? outputConfig.defaultFormat() : outputOptions.getOutputFormatConfig().getRecordWriterFactory();
