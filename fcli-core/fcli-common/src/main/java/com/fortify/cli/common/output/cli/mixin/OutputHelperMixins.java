...
/**
 * <p>
 * This class provides standard {@link IOutputHelper} implementations.
 * Individual product modules may provide additional {@link IOutputHelper}
 * implementations as needed, extending from one of these classes as
 * appropriate:
 * </p>
 * <ul>
 ...
 * format; subclass should provide {@code CMD_NAME} constant</li>
 * <li>{@link TableNoQuery}, providing no query options and default table output
 * format; subclass should provide {@code CMD_NAME} constant</li>
 * </ul>
 *
 * <p>
 * All standard output helper mixins defined in this class are based on
 * {@code TableNoQuery}, except for the {@code List} class which is based on
 * {@code TableWithQuery}.
 * </p>
 *
 * Every command implementation should use the appropriate {@link IOutputHelper}
 * (where {@code CMD_NAME} matches the command name), either from the standard
 * implementations provided in this class, or from the product-specific
 ...
 *
 * <p>
 * Here, {@code AbstractMyProductOutputCommand} would extend from
 * {@link AbstractOutputCommand}, which takes care of displaying the output
 * generated by the command, based on the configured {@link IOutputHelper}
 * {@link Mixin}.
 * </p>
 *
 * @author rsenden
