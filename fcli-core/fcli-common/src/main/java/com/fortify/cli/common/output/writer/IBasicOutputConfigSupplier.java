...
/**
 * Interface for supplying a basic output configuration which may not have been
 * fully configured yet. For example, {@link AbstractOutputHelperMixin} will
 * update the basic output configuration, like adding transformers from various
 * sources.
 *
