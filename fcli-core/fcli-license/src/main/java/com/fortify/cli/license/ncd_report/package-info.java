 ...
 *    <li>Creates a new NcdReportContext instance for collecting and outputting
 *        data generated by the various sources.</li>
 *    <li>For each of the source configurations, requests the source-specific generator,
 *        passing in the NcdReportContext instance created above, and invoking
 ...
 *        configuration.</li>
 *    <li>Invokes reportContext().repositoryProcessor().processRepository(...)
 ...
 *   </ol></li>
 *   <li>The reportContext().repositoryProcessor().processRepository(...) method:
 *    <ol>
