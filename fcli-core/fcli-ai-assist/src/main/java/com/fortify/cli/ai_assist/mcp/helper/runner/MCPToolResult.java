...
public class MCPToolResult {
    ...
    public static MCPToolResult fromCompletedPagedResult(MCPToolResult plainResult, int offset, int limit) {
        return fromCompletedPagedResult(plainResult, offset, limit, null);
    }

    public static MCPToolResult fromCompletedPagedResult(MCPToolResult plainResult, int offset, int limit, String jobToken) {
        var allRecords = plainResult.getRecords();
        var pageInfo = PageInfo.complete(allRecords.size(), offset, limit).toBuilder().jobToken(jobToken).build();
