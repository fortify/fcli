...
/**
 * <p>Describe a repository. Implementations must at least provide the 
 * properties defined by this interface, and may optionally define 
 ...
 * @author rsenden
 */
public interface INcdReportRepositoryDescriptor {
    String getFullName();
    String getUrl();
    boolean isFork();
