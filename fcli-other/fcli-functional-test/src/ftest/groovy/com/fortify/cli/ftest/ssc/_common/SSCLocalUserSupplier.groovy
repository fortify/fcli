...
public class SSCLocalUserSupplier implements Closeable, AutoCloseable {
    ...
    public static class SSCUser { 
        ...
        public SSCUser create() {
            Fcli.run("ssc ac create-local-user --username $userName" + 
        ...
        public void close() {
            Fcli.run("ssc ac delete-user ::$fcliVariableName::userName",
